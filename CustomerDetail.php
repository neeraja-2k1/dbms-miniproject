...
{	
    ...
    $sql = "INSERT INTO customer(customer_id,fname,lname,contno,mailid,doorno,street,area,location,pincode,paying_method,cust_prem)
...
<br>
    <p><a href="newpg.html">Back to Menu</a></p>
    <br>
